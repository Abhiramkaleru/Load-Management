...
import { colors, font } from "./Tokens";
import LoadRequestList from "./LoadRequestList";
import LoadRequestDetail from "./LoadRequestDetail";
    ...
    >
      ...
      {!isMobile && (
        <Sidebar
          ...
          onNavigate={(key) => {
            if (key === "load-request") backToList();
          }}
        />
      )}
      ...
      >
        {view === "list" && (
          <LoadRequestList onOpenRequest={openDetail} setToast={setToast} />
        )}
        {view === "detail" && (
          <LoadRequestDetail
